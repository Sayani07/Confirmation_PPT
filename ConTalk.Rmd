...
### Provide a platform to <span style="color:Crimson"> systematically <span style="color:Black"> explore multiple perspectives of <span style="color:Crimson"> spatio-temporal data <span style="color:Black"> across deconstructed time and space to find regular patterns or anomalies, explore clusters of behaviors or summarize the behavior through <span style="color:Crimson"> probability distributions <span style="color:Black"> in an <span style="color:Crimson"> open source environment
...
### <span style="color:Black"> Visualization of probability distributions of deconstructed temporal data
<br>
<br>
### <span style="color:Black"> Spatio-temporal granularities and probability distribution plots
<br>
<br>
### <span style="color:Black"> Clustering algorithms for grouping probability distributions on spatio-temporal granularities
<br>
<br>
...
p1 = SU_uniform_mutate %>% filter(Source=="B1 05") %>%
  ...
  ggplot(aes(x=wday, y=dkwh)) + geom_boxplot() + 
    coord_cartesian(ylim = c(0,0.75)) + ggtitle("B1 05")
...
p2 = SU_uniform_mutate %>% filter(Source=="B4 29") %>%
  ...
  mutate(wday = wday(date, label = TRUE, abbr = TRUE,
                     week_start = 1)) %>%
  ggplot(aes(x=wday, y=dkwh)) + geom_boxplot() +
    coord_cartesian(ylim = c(0,0.75)) + ggtitle("B4 29")
...
## <span style="color:DarkBlue">  Across HoD and Work-Day/Non-Work-Day
