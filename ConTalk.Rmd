...
# <span style="color:DarkBlue"> Visualizing distributions across circular granularities (I)
<font size="-1"> **Frequency** ~ 30 minutes interval smart meter data of Monash Residential Services, <font size="-1"> **Time frame** ~ April 4, 2018 to May 31, 2018, <font size="-1"> **Spread** ~ 73 living units
...
.right-column[
.pull-left[
```{r b429-12,fig.height=4, fig.width=6, echo=FALSE}
p4
```
]
.pull-right[
```{r b429-13,fig.height=4, fig.width=6, echo=FALSE}
p6
```
]
]
