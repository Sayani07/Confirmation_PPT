...
class: middle left
Provide a platform to systematically explore multiple perspectives of spatio-temporal data and support the exploratory analysis to find regular patterns or anomalies, explore clusters of behaviors or summarize the behavior through probability distributions
...
---
## Illustratives calendar categorisations

```{r Modarith, echo=FALSE, out.width="50%"}
knitr::include_graphics("modarith-table.png")
```
_* $n_i$ is the number of categories created by $C_i$ *_

## criteria for plots that work vs plots that don't

- Structurally Empty Combinations

Examples: DoM and DoY

- Non-functional Empty Combinations 

Examples: Working/Non-working day and HoD

---

# Rules to assess Clashes
...
knitr::kable(cbind(s, C9, C10), format = "html")
knitr::kable(rule_2(s, a=2,b=6,m1=3,m2=4) , format = "html")
```
]
