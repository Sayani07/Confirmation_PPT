...
<br>
<br>
<span style="color:Crimson">  These definitions for linear granularities are inadequate for conceptualizing circular granularities since the linearity imposes a restriction on reflecting periodicities in time
...
```{r Modarith, echo=FALSE, out.width="100%"}
knitr::include_graphics("modarith-table.png")
```
.tiny[ $n_i$ is the number of categories created by $C_i$  
time index ~ hourly ]
]

---

### <span style="color:DarkBlue"> Guiding rules to control for Clashes
.pull-left[
